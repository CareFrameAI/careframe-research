...
class DataCollectionWidget(QWidget):
    ...
    def sanitize_study_code(self, code):
        """
        Sanitize generated study code without removing function definitions
        
        Args:
            code (str): The code generated by the LLM
            
        Returns:
            str: Cleaned code preserving function definitions
        """
        ...
        # Only remove example usage and print statements
        filtered_lines = []
        for line in lines:
            # Skip example usage
    ...
    async def generate_study_data(self, inputs):
        ...
        try:
            ...
            # Clean up the code - use study-specific sanitization to preserve function definitions
            code = self.sanitize_study_code(response)
    ...
    def sanitize_grouping_code(self, code, variable_name=None):
        """
        Sanitize the grouping variable code by removing extraneous code
        
        Args:
            code (str): The code generated by the LLM
            variable_name (str, optional): The name of the grouping variable. Defaults to None.
        ...
        # Add a comment explaining what this code does, only if variable_name is provided
        if variable_name:
